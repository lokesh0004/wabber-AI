...
import { Search, Mic, Moon, Sun, ClipboardList, HelpCircle } from 'lucide-react';
...
const SearchBar = () => {
  ...
  return (
    <div className={`${darkMode ? 'bg-black' : 'bg-white'} relative min-h-screen overflow-hidden transition-all`}>
      ...
      {/* 🌟 Webber AI Branding */}
      <div className="fixed top-6 left-6 z-50 text-2xl font-bold tracking-wide animate-titlePulse">
